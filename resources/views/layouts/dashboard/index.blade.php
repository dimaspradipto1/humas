    ...
    <div class="row">
            ...
            <div class="card bg-yellow-100 border-0 shadow">
              <div class="card-header d-sm-flex flex-row align-items-center flex-0">
                <div class="d-block mb-3 mb-sm-0">
                  ...
                  <h2 class="fs-3 fw-extrabold text-capitalize">monitoring pelaporan kegiatan</h2>
        ...
        <div class="col-6 col-xl-6">
            <div class="card bg-yellow-100 border-0 shadow">
              ...
              <div class="card-body p-2">
                <div class="line-chart ct-double-octave"></div>
              </div>
            </div>
        </div>
                    ...
                    <div class="card-header d-flex flex-row align-items-center flex-0 border-bottom">
                        ...
                        <div class="d-block ms-auto">
                            <div class="d-flex align-items-center text-end">
                                <span class="dot rounded-circle" style="background-color: #007F3B; margin-right: 0.5rem;"></span>
                                <span class="fw-normal small text-uppercase">rektorat</span>
                            </div>
                            <div class="d-flex align-items-center text-end">
                                <span class="dot rounded-circle" style="background-color: #fe9a20; margin-right: 0.5rem;"></span>
                                <span class="fw-normal small">FEB</span>
                            </div>
                            <div class="d-flex align-items-center text-end mb-2">
                                <span class="dot rounded-circle" style="background-color: #810000; margin-right: 0.5rem;"></span>
                                <span class="fw-normal small">FST</span>
                            </div>
                            
                            <div class="d-flex align-items-center text-end">
                                <span class="dot rounded-circle" style="background-color: #B33791; margin-right: 0.5rem;"></span>
