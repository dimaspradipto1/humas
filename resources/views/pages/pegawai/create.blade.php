                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="no_wa" name="no_wa" type="number"
                                    value="{{ old('no_wa') }}" placeholder="Masukkan nomor whatsapp" />
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="me-3">
                                    ...
                                    <img class="rounded avatar-xl" id="preview-foto"
                                        src="{{ asset('volt/assets/img/team/avatar-grey.png') }}" alt="preview" />
                                </div>
        ...
        function previewImage(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    document.getElementById('preview-foto-top').src = e.target.result;
                }
